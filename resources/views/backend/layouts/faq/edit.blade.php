@extends('backend.app', ['title' => 'Edit FAQ'])
                                ...
                                <form id="editFaqForm" action="{{ route('admin.faq.update', $faq->id) }}" method="POST">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="question" class="form-control"
                                            value="{{ $faq->question }}" placeholder="Enter your question" required>
                                    </div>

                                    <div class="mb-4">
                                        <label class="form-label">Answer <span class="text-danger">*</span></label>
                                        <textarea name="answer" id="answer" class="form-control summernote">{!! $faq->answer !!}</textarea>
                                    </div>
