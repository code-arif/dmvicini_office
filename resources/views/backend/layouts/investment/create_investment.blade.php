                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card product-sales-main">
                            <div class="card-body">
                                <form id="createInvestmentForm" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="summary" rows="3" class="form-control summernote"></textarea>
                                    </div>
                                    ...
                                    <div class="mb-3" id="mapUrlBox" style="display: none;">
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            // Initialize Map
            const defaultLocation = [23.8103, 90.4125]; // Dhaka
            ...
            // Form submit AJAX
            $('#createInvestmentForm').on('submit', function(e) {
                e.preventDefault();
                let formData = new FormData(this);

                $.ajax({
                    url: "{{ route('store.investment') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
