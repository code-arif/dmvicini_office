...
@section('content')
                            ...
                            <div class="card-header border-bottom">
                                ...
                                <div class="card-options ms-auto">
                                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#createTaxStrategyModal">Add Tax Strategy</button>
                                </div>
                            </div>
                            <div class="card-body">
    ...
    <div class="modal fade" id="createTaxStrategyModal" tabindex="-1" aria-labelledby="createTaxStrategyModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                <form id="createTaxForm" method="post">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="createTaxStrategyModalLabel">Add New Tax Strategy</h5>
    ...
    <!-- Edit Category Modal -->
    <div class="modal fade" id="editTaxStrategyModal" tabindex="-1" aria-labelledby="editTaxStrategyModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form id="editStrategyForm" method="post">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="editTaxStrategyModalLabel">Edit Strategy</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group mb-2">
    ...
    <script>
        $(document).ready(function() {
            ...
            let dTable = $('#datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('show.tax.strategy.list') }}",
                    type: "GET",
                },
                columns: [{
                        data: 'DT_RowIndex',
        ...
        function showDeleteConfirm(id) {
            ...
            Swal.fire({
                title: 'Are you sure you want to delete this tax strategy?',
        ...
        function deleteItem(id) {
            NProgress.start();
            let url = "{{ route('tax.strategy.delete', ':id') }}";
