            ...
            <div class="modal-content">
                <form id="createClassForm">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Create Investment Type</h5>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form id="editTypeForm">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Edit Investment Type</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateOrder() {
                ...
                NProgress.start();
                $.ajax({
                    url: "{{ route('investment.type.update.order') }}",
                    type: "POST",
                    data: {
                    ...
                    success: function(res) {
                        ...
                        if (res.success) {
                            ...
                            loadInvestmentTypes(); // Reload to show updated order badges
                        }
                    },
                    error: function() {
                        NProgress.done();
        ...
        function showDeleteConfirm(id) {
            Swal.fire({
                title: 'Are you sure?',
                text: 'This investment type will be deleted permanently!',
                icon: 'warning',
        ...
        function deleteItem(id) {
            ...
            $.ajax({
                type: "DELETE",
                url: "{{ route('investment.type.delete', ':id') }}".replace(':id', id),
                headers: {
                ...
                success: function(res) {
                    ...
                    if (res.success) {
                        toastr.success(res.message);
                        loadInvestmentTypes(); // Reload instead of location.reload()
                    }
                },
                error: function() {
                    NProgress.done();
