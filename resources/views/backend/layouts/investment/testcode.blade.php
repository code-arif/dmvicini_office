...
@push('scripts')
    ...
    <script>
        ...
        function goToStep(step) {
            ...
            $('#nextBtn').toggle(currentStep < script totalSteps);
        ...
        function submitInvestment() {
            ...
            promises.push(
                $.ajax({
                    url: `{{ url('admin/investment') }}/${investmentId}/highlight`,
                    type: "POST",
                    data: highlightData
                })
            );
            ...
            documents.forEach(doc => {
                ...
                promises.push(
                    $.ajax({
                        url: `{{ url('admin/investment') }}/${investmentId}/document`,
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false
            ...
            if (images.length > 0) {
                ...
                promises.push(
                    $.ajax({
                        url: `{{ url('admin/investment') }}/${investmentId}/images`,
                        type: "POST",
                        data: imageFormData,
                        processData: false,
                        contentType: false
            ...
            disclaimers.forEach(disc => {
                promises.push(
                    $.ajax({
                        url: `{{ url('admin/investment') }}/${investmentId}/disclaimer`,
                        type: "POST",
                        data: {
                            title: disc.title,
